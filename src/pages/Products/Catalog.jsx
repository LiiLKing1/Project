  ...
  return (
    <div className="catalog-macro-card">
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '4px' }}>
        <span className="catalog-macro-value">{value}{unit ? ` / ${unit}` : ''}</span>
...
const Catalog = () => {
  ...
  return (
    <div className="catalog-container">
      ...
      {/* MacroCards */}
      <div className="catalog-macro-container" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
        <MacroCard label="Jami Qoldiq" value={formatCompact(totalPhysicalStock)} maxValue={10000} trend="Barchasi" isAlert={false} icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M20 7h-7L10 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path></svg>}/>
