...
import { Mail, Lock, Eye, EyeOff, KeyRound, Laptop } from 'lucide-react';
...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    if (isElectron) {
      // In electron, this opens the browser and we wait for the IPC success event 
      // which updates currentUser globally.
      loginWithGoogle();
      return;
    }
